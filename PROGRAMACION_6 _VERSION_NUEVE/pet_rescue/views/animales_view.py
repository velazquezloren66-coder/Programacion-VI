...
#1. Lograr que también se limpien los combo boxes en vista Animales Rescatados con ayuda de un botón
#de refresh (Actualizar vista) al lado del botón Limpiar para así visualizar nuevamente vacíos esos dos
#combo boxes de Especie y Estado
...
class AnimalesView:
                ...
                content=ft.Column([
                    ...
                    crear_card(
                        ft.Column([
                            ...
                            # NUEVO: Agregar botón de refresh al lado de limpiar
                            ft.Row([
                                btn_guardar,
                                btn_limpiar,
                                btn_refresh
    ...
    # NUEVO: Método para refrescar la vista
