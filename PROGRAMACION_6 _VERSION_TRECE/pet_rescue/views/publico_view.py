#Ahora permite imágenes en las tarjetas o cédulas de los animalitos disponibles para la
#adopción, estas imágenes vienen de la vista de Animales Rescatados que manejan los
#administradores, ellos cargan las imágenes de los animalitos en adopción y más
