#Coloqué en gris la opción de eliminar los registros que estén con estado Adoptado.

#En el momento de editar Animales rescatados, solo traiga la opcion "Adoptado" en el
#combo box de Especie si lo tiene ya (o sea, en el momento de editar y es "Adoptado", ahí sí trae esa opción
#junto con los demás), pero si es para guardar un nuevo registro no trae la opción de "Adoptado",
#porque eso se debe traer de la vista de Adopciones.
        ...
        try:
            ...
            if animales:
                for animal in animales:
                    ...
                    #MI MODIFICACIÓN: Botón eliminar en gris si estado es "Adoptado"
    ...
    def editar_animal(self, id):
        try:
            ...
            if animales:
                ...
                #OTRA MODIFICACIÓN: Configuré opciones del estado según si ya está adoptado
