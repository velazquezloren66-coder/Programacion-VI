#Ahora da mensaje de que el registro fue eliminado correctamente, siempre y cuando sea un registro en el
#que el estado no sea "Adoptado", sino de por sí no le da la posibilidad de eliminar porque el basurerito
#está en color gris.
