#CAMBIOS:
#1.	Se solucionó el problema de Whatsapp, ahora ya abre una pestaña en el navegador, donde da
#la opción de Whatsapp web o la app en sí, y al entrar a Whatsapp ya abre el chat dirigido al
#número colocado en la vista.

#2.	Se solucionó el problema de “Mapa de ubicación”, ahora ya abre Maps en el navegador con la
#dirección ficticia del refugio.
