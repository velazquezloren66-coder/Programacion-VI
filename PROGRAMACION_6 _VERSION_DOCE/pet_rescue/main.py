...
#1.	Añadí la opción de entrar como admin (debe iniciar sesión y ver todas las vistas) o
#usuario normal, en una vista pública en la que no hace falta iniciar sesión (solo ve los
#animalitos disponibles y la vista de contacto).

#2.	En la vista pública:
#•	Se ven los datos de los animalitos disponibles para ser adoptados.
#•	Se ve una opción en cada "cédula" de los animalitos con el título "Me interesa adoptar"
#que lleva a la vista de Contáctenos con los datos para contactar con el refugio.
#•	Cuenta además con un botón aparte, en la parte superior derecha, que lleva también a la
#vista de Contáctenos.
